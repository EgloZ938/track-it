...
export default function RetardEtudiants() {
    ...
    const validateAndSubmitTicket = async () => {
        ...
        try {
            ...
            const MAX_DISTANCE_KM = 5.5; // Max 500 mètres de la station
            ...
            if (!relevantDisruption) {
                Alert.alert(
                    ...
                    "Aucune perturbation significative ou retard n'est actuellement signalée par l'API pour cette ligne et/ou station."
                );
                setIsSubmitting(false);
                return;
            }
            ...
            <View style={styles.arrierePlan}>
                ...
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>Créez un justificatif basé sur les perturbations réelles.</Text>
                    </View>
